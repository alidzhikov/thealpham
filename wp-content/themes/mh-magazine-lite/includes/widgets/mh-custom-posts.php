        ...
        echo $args['before_widget'];
			...
			<ul class="mh-custom-posts-widget clearfix"><?php
				...
				<li class="mh-custom-posts-item mh-custom-posts-large clearfix">
						<div class="mh-custom-posts-thumb-big">
						...
						<div class="mh-custom-posts-content">
							<header class="mh-custom-posts-header">
								...
								<div class="mh-meta mh-custom-posts-meta mh-meta-big">
									<?php mh_magazine_lite_loop_meta(); ?>
								</div>
							</header>
							<div class="mh-excerpt">
								<a class="mh-excerpt-more" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
									<?php the_excerpt(); ?>
								</a>
							</div>
						</div>
